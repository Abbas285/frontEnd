            ...
            >
                <div className='flex  items-center justify-between'>
                    ...
                    {toggle && <Image
                        ...
                        height={500}
                        quality={100}
                        className="w-[20px] h-[20px] object-contain cursor-pointer hover:scale-110 transition-all "
                        onClick={() => {
                            setToggle(false)
                        }}
                    />}
                    ...
                    <div className='w-full flex flex-col pt-3'>
                        ...
                        <div className='flex justify-between pt-2'>
                            <div className='flex-col flex 
                             items-center 
                             border hover:border-2 px-3 
                             py-2 rounded-md hover:border-[#3F20FB]'>
                                <Image
                                    src={wireframes}
                                    alt="wireframes"
                                    width={500}
                                ...
                                hover:font-medium hover:text-[#3F20FB] font-normal text-[#606067]">
                                    Wireframes
                                </h3>
                            </div>
