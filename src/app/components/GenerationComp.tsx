    ...
    return (
        <div className="w-full flex justify-start items-center">
            <div className="  px-3 py-2 bg-white rounded-md border
             shadow-md cursor-pointer hover:scale-105 transition-all w-[85%]">
                ...
                <div className='w-full flex flex-col pt-3'>
                    ...
                    <div className='w-full flex flex-col pt-5 '>
                        ...
                        <div className='flex  border rounded-md  text-[#303034]'>
                            <div className='p-2 hover:bg-[#ece9ff]  hover:rounded-l-sm  w-1/4 text-center hover:text-[#3F20FB]'>
                                1
                            </div>
                            <div className='p-2 hover:bg-[#ece9ff]   w-1/4 text-center hover:text-[#3F20FB]'>
                                2
                            </div>
                            <div className='p-2 hover:bg-[#ece9ff]   w-1/4 text-center hover:text-[#3F20FB]'>
                                3
                            </div>
                            <div className='p-2 hover:bg-[#ece9ff]  hover:rounded-r-sm w-1/4 text-center hover:text-[#3F20FB]'>
                                4
                            </div>
                        </div>
                    </div>
